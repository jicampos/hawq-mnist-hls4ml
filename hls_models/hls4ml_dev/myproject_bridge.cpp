...
void myproject_float(
    ...
    result_t layer43_out_ap[N_LAYER_43];

    myproject(global_in_ap,layer43_out_ap);

    nnet::convert_data<result_t, float, N_LAYER_43>(layer43_out_ap, layer43_out);
}

void myproject_double(
    double global_in[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1],
    double layer43_out[N_LAYER_43]
) {
    input_t global_in_ap[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1];
    ...
    nnet::convert_data<result_t, double, N_LAYER_43>(layer43_out_ap, layer43_out);
}
